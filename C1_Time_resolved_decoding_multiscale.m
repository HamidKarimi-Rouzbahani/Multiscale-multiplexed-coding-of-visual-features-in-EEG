...
for partid=[1:16]
    % loading the data and trial labels
    ...
    for info_type=[1:4] % which of four features is being decoded
        ...
        save(['F:\RESEARCH\Hamid\MultiScale\',sprintf('Decoding_data_8windows_Nobslin_trlsEq_subj_%02i.mat',partid)],'accuracy')
    end
    clearvars accuracy
end