function [partid] = C3_different_window_length_decoding_parallel(partid,SOA)
addpath(genpath('/home/uqhkarim/MatlabProjects/Claire/eeglab2021.1'))
tic
load(sprintf('/scratch/user/uqhkarim/EEG_temporal_scales/Data/sub-%02i_task-rsvp_500HZ.mat',partid),'EEG_epoch')
eventlist=tdfread(sprintf('/scratch/user/uqhkarim/EEG_temporal_scales/Data/sub-%02i_task-rsvp_events.tsv',partid));
%% Parameters
channels=1:127;
